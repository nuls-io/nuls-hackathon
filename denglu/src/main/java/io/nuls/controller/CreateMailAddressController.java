...
public class CreateMailAddressController implements BaseController {
	...
	//获取账户私钥
	@Path("getPriKeyByAddress")
	@Produces(MediaType.APPLICATION_JSON)
	@POST
	public BaseResult getPriKeyByAddress(User user) {
		 return call(()-> new Result(accountTools.getPriKeyByAddress(user.getAddress(), user.getPassword())));
	}
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @POST
    public BaseResult createMailAddress(CreateMailAddressReq req)  {
        return call(() -> {
            Transaction tx = null;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @GET
    public BaseResult getMailAddress(@PathParam("address") String address) {
