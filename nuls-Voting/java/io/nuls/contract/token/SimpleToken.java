...
public class SimpleToken implements Contract, Token, Voting  {
    ...
    private final String md5forVotingEvent;
    ...
    @Override
    @View
    public String md5forVotingEvent(){
        return md5forVotingEvent;
    }
    ...
    public SimpleToken(@Required String name,@Required String detail,@Required String resource, @Required String md5forVotingEvent,@Required String symbol, @Required BigInteger initialAmount, @Required int decimals) {
        this.name = name;
        this.symbol = symbol;
        this.decimals = decimals;
        this.detail = detail;
        this.resource = resource;
        this.md5forVotingEvent = md5forVotingEvent;
    ...
    public boolean votingTransferFrom (@Required Address from, @Required Address to, String transfertype, String votecontractaddr , String introduce , String resource , String md5remark , @Required BigInteger value) {
        subtractAllowed(from, Msg.sender(), value);
        subtractBalance(from, value);
        addBalance(to, value);
        emit(new VotingTransferEvent(from, to,transfertype , votecontractaddr , introduce , resource ,md5remark ,value));
        return true;
    }
    ...
    public boolean votingTransfer(@Required Address to,String transfertype , String votecontractaddr , String introduce ,String resource ,String md5remark , @Required BigInteger value) {
        subtractBalance(Msg.sender(), value);
        addBalance(to, value);
        emit(new VotingTransferEvent(Msg.sender(), to,transfertype , votecontractaddr , introduce , resource ,md5remark , value));
        return true;
    }
