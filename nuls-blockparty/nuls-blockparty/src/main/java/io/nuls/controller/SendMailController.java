...
/**
 * @author uthor: nmschorr based on code from zhoulijun
 * @date  2019-09-24
 * @Description:
 */
@Path("/")
...
public class SendMailController implements BaseController {
    ...
    public Result<String> sendBP(SendMailReq theREQUEST) {
        return call(() -> {
            ...
            String txHash_STR = the_TX.getHash().toHex();
            ...
            System.out.println("nms sendBal after before conversion:  " + senderAvailBal_BI);
